...
export default function Page() {
  const repoHref = "https://github.com/jasontech1998/silhouette-exercise";
  const demoHref = "https://silhouette-exercise.vercel.app/";
    ...
    <section>
      ...
      <div className="flex mb-8">
        <p className="text-sm self-end leading-snug text-muted-foreground">
          Silhouette is developed using Tremor and Next.js as an
          exercise for building marketing landing pages for a computing
          technology brand.
        </p>
      </div>
      ...
      <div className="py-3">
        ...
        <p className="text-xs text-muted-foreground mb-4 italic">
          Note: Silhouette is a fictional/concept company created for
        ...
        <div className="flex mt-4 p-4 justify-center rounded-md border-accent border-2">
          <video width="650" height="750" controls autoPlay loop muted>
            <source
              src="/assets/projects/silhouette-demo.mp4"
              type="video/mp4"
            />
